...
the \emph{scipy.stats} package using Python 3.11.9. The results are shown in
...
a strong monotonic relationship. Lastly, the Kendall tau correlation indicates
a strong ordinal relationship between the traditional H-Index and the adjusted
H-Indexes.
...
It is important to acknowledge that, the observed differences in the stringency
...
citations, which was proven by the fact that the clustering coefficients
...
with the differences being more pronounced in some subject areas than others.
